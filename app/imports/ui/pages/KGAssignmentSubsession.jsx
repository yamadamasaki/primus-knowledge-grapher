...
import KGTeamsSection from '../sections/KGTeamsSection'

const KGAssignmentSubsession = () => {
  ...
  const {subsessionName, canReadText, canWriteText, canReadTeams, canWriteTeams} = mySpec
                  ...
                  <>
                    ...
                    <ProgramIndexMenu program={program}>
                      <div style={{/*height: '100vh'*/}}>
                        ...
                        <KGTeamsSection {...params} canRead={canReadTeams} canWrite={canWriteTeams}/>
                      </div>
                    </ProgramIndexMenu>
                  </>
              ) : <ShowError/>
...
export default KGAssignmentSubsession
