...
const ConnectorStyleTabPane = ({symbols}) => {
  ...
  return (
      <Grid>
        ...
        <Grid.Row>
          ...
          <Grid.Column width={8}>
            <Slider
                settings={{start: strokeWidth, onChange: onValueChange('strokeWidth'), min: 0, max: 10, step: 0.2}}/>
          </Grid.Column>
...
export default ConnectorStyleTabPane
